...
#define MyAppURL "https://github.com/arnauddalayer/cindex-win"
...
AppId=F2857BCC-C5BA-4FAC-987C-30AD24F5EF5B
AppName={#MyAppName}
AppMutex=CindexPublisherMutex
...
DefaultDirName={autopf}\{#MyAppName} {#MyAppVersion} {#MyAppEdition}
...
[Files]
Source: "inno\Publisher\Cindex.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "inno\Publisher\readme.rtf"; DestDir: "{app}"; Flags: ignoreversion isreadme
Source: "inno\Publisher\Publisher Supplement.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\{#MyAppName} {#MyAppVersion} Guide Supplement"; Filename: "{app}\Publisher Supplement.pdf"
...
Root: HKLM; Subkey: "SOFTWARE\Indexing Research\Cindex\4.0"; ValueType: string; ValueName:"Owner"; ValueData: "CINDEX"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\Indexing Research\Cindex\4.0"; ValueType: string; ValueName:"Company"; ValueData: "Publishers' Edition"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\Indexing Research\Cindex\4.0"; ValueType: string; ValueName:"Sernum"; ValueData: "0000000000-0000"; Flags: uninsdeletekey
